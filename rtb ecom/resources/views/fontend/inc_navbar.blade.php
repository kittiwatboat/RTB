              ...
              <div class="mega-content px-4">
                <div class="container-fluid">
                  <div class="row">
                    ...
                    <div class="col-12 col-sm-6 col-md-4 py-4" id="menuMega">
                      <div id="menu1" class="tabcontent" style="display: block;">
                        <a href="productsAllinBrand.php">Jabra Mobiles</a>
                        <ul class="dash">
                          <li>Jabra True wireless</li>
                          <li>Bluetooth Headsets</li>
                          <li>In-Car Speakerphones</li>
                          <li>Music & Sport Headsets</li>
                          <li>Corded Stereos</li>
                        </ul>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body px-lg-5 px-3 mb-lg-5 mb-3">
          <div class="row">
            ...
            <a type="button" class="btn btn-green rounded-pill mt-lg-5 mt-3" type="submit" href="profile.php">เข้าสู่ระบบ</a>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body px-lg-5 px-3 py-0 pb-4">
          <div class="row">
            ...
            <button type="button" class="btn btn-green rounded-pill mt-3" type="submit">สมัครสมาชิก</button>
