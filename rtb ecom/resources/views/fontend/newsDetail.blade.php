...
<body>
    ...
    <div class="container" id="news">
        <div class="row">
            <div class="col-sm-12 col-md-9 mt-lg-5 mt-4">
                <img src="images/News/newsDetail.png" class="w-100">
                <div class="border-bottom my-lg-4 my-0 px-lg-3 px-0 py-3">
                    <h5>JABRA ELITE 2 and JABRA ELITE 3 shake the market with a new design. with state-of-the-
                        art audio technology</h5>
                    <div>
                ...
                <div class="px-lg-3 px-0 py-3">
                    <p class="mb-4">RTB ontinues to open up a new experience of listening to quality music continuously. deliveve headphones Jabra Elite 2 and Jabra Elite 3 shaking the market</p>
                    <p class="mb-4">Stand out with a new design. with state-of-the-art audio technology to increase the freedom to listen to music anytime, anywhere without limitations</p>
                    <p class="mb-4">RTB Technology Co, ttd, a major importer and distributor of gadgets in Thailand. And is a distributor of
                        ...
                        models Jabra Elite 2 and Jabra Elite 3, are an important step in the development of Jabra's True Wireless
                    ...
                    <p class="mb-4">For lovers of quality music You can buy and experience clear music from the most innovative headphones from "Jabra" (Jabra) models <span class="fw-medium">Jabra Elite 2</span> and <span class="fw-medium">Jabra Elite 3</span> are available today at</p>
            ...
            <div class="col-sm-12 col-md-3 mt-lg-5 mt-0 px-4">
                <h5>Categories</h5>
                <div class="progress">
                    <div class="progress-bar bg-green" style="width:20%"></div>
                </div>
                <div class="cateNews my-3">
                    <ul class="no-list-style px-3">
