...
! function () {
    ...
    var l = function () {
        ...
        return t = e, o = [{
            ...
            value: function (t, i, o) {
                var s;
                if (t) return void 0 !== o && (o = Boolean(o)), e.getElements(t).forEach((function (e) {
                    s = e.classList.toggle(i, o)
                })), s
            }
        }, {
            key: "hasClass",
            ...
            key: "addEvent",
            value: function (t, i, o) {
                t && (i = s.removeArrayEmpty(i.split(" "))).forEach((function (i) {
            ...
            return t = e, o = [{
                ...
                value: function (t) {
                    ...
                    if (i) {
                        ...
                        return i.forEach((function (i) {
                            t.ele = i, "SELECT" === i.tagName && e.setPropsFromSelect(t), n.push(new e(t))
                        })), o ? n[0] : n
                    }
                }
            }, {
                ...
                value: function (e) {
                    ...
                    i.forEach((function (e) {
                        ...
                        o.push({
                            label: e.innerHTML,
                            value: t
                        }), e.disabled && s.push(t), e.selected && n.push(t)
                    }));
                    var r = document.createElement("div");
                    l.setAttrFromEle(t, r, Object.keys(m), f), t.parentNode.insertBefore(r, t), t.remove(), e.ele = r, e.options = o, e.disabledOptions = s, e.selectedValue = n
                }
            }, {
                key: "onFormReset",
                value: function (e) {
                ...
                value: function () {
                    if (this.$ele) {
                        var e = this.uniqueId,
                            ...
                            n = !1;
                        this.additionalClasses && (t += " " + this.additionalClasses), this.multiple && (t += " multiple", this.disableSelectAll || (t += " has-select-all")), this.hideClearButton || (t += " has-clear-button"), this.keepAlwaysOpen ? (t += " keep-always-open", n = !0) : t += " closed", this.showAsPopup && (t += " show-as-popup"), this.hasSearch && (t += " has-search-input"), this.showValueAsTags && (t += " show-value-as-tags"), this.textDirection && (t += " text-direction-".concat(this.textDirection)), this.popupPosition && (t += " popup-position-" + this.popupPosition.toLowerCase());
                        var r = '<div id="vscomp-ele-wrapper-'.concat(e, '" class="vscomp-ele-wrapper ').concat(t, '" tabindex="0" role="combobox"\n        aria-haspopup="listbox" aria-controls="vscomp-dropbox-container-').concat(e, '" aria-expanded="').concat(n, '" ').concat(s, '\n      >\n        <input type="hidden" name="').concat(this.name, '" class="vscomp-hidden-input">\n\n        <div class="vscomp-toggle-button">\n          <div class="vscomp-value" ').concat(i, ">\n            ").concat(this.placeholder, '\n          </div>\n\n          <div class="vscomp-arrow"></div>\n\n          <div class="vscomp-clear-button toggle-button-child" ').concat(o, '>\n            <i class="vscomp-clear-icon"></i>\n          </div>\n        </div>\n\n        ').concat(this.renderDropbox({
                            wrapperClasses: t
                        }), "\n      </div>");
                ...
                value: function (e) {
                    ...
                    if (i) {
                        ...
                        return this.$dropboxWrapper = s, this.hasDropboxWrapper = !0, s.innerHTML = o, i.appendChild(s), l.addClass(s, "vscomp-dropbox-wrapper ".concat(t)), ""
                    }
                ...
                value: function () {
                    ...
                    if (a && (e = new RegExp("(".concat(this.searchValue, ")"), "gi")), this.multiple && (n = '<span class="checkbox-icon"></span>'), this.allowNewOption) {
                        var d = this.getTooltipAttrText("New Option");
                        r = '<span class="vscomp-new-option-icon" '.concat(d, "></span>")
                    }
                    o.forEach((function (o) {
                        var s, d = o.index,
                            v = "vscomp-option",
                            f = t.getTooltipAttrText("", !0, !0),
                            y = n,
                            b = "",
                            g = "",
                            m = "",
                ...
                value: function (e, t, i) {
                    ...
                    e && (t = s.removeArrayEmpty(t.split(" "))).forEach((function (t) {
                        var s = "".concat(i, "-").concat(t),
                            n = o.events[s];
                        n || (n = o[i].bind(o), o.events[s] = n), l.addEvent(e, t, n)
                    }))
                }
            }, {
                key: "onDocumentClick",
                ...
                value: function (e) {
                    ...
                    t && !l.hasClass(t, "disabled") && (l.hasClass(t, "group-title") ? this.onGroupTitleClick(t) : this.selectOption(t, {
                        event: e
                    }))
                }
            }, {
                ...
                value: function (e) {
                    var t = e.target.closest(".vscomp-option");
                    t && this.isOpened() && (l.hasClass(t, "disabled") || l.hasClass(t, "group-title") ? this.removeOptionFocus() : this.focusOption(null, t))
                }
            }, {
                ...
                value: function () {
                    ...
                    if (this.hasDropboxWrapper) {
                        ...
                        this.mutationObserver = new MutationObserver((function (i) {
                            i.some((function (i) {
                                var o = u(i.removedNodes).some((function (e) {
                ...
                value: function () {
                    var e = this.getVisibleOptions(),
                        ...
                        i = !t && !e.length;
                    (!this.allowNewOption || this.hasServerSearch || this.showOptionsOnlyOnSearch) && l.toggleClass(this.$allWrappers, "has-no-search-results", i), l.toggleClass(this.$allWrappers, "has-no-options", t), this.setOptionAttr(), this.setOptionsPosition(), this.setOptionsTooltip()
                }
            }, {
                ...
                value: function (e) {
                    var t = e.ele;
                    for (var i in m) {
                        var o = t.getAttribute(i); - 1 === f.indexOf(i) || "" !== o && "true" !== o || (o = !0), o && (e[m[i]] = o)
                    }
                }
            }, {
                key: "setEleProps",
                ...
                value: function (e, t) {
                    var i = {},
                        ...
                        s = this.multiple;
                    if (e) {
                        if (Array.isArray(e) || (e = [e]), s) {
                            var n = this.maxValues;
                            n && e.length > n && e.splice(n)
                        } else e.length > 1 && (e = [e[0]]);
                        e = e.map((function (e) {
                            return e || 0 == e ? e.toString() : ""
                        })), this.useGroupValue && (e = this.setGroupOptionsValue(e)), e.forEach((function (e) {
                            i[e] = !0
                        })), this.allowNewOption && e && this.setNewOptionsFromValue(e)
                    }
                    this.options.forEach((function (e) {
                        !0 !== i[e.value] || e.isDisabled || e.isGroupTitle ? e.isSelected = !1 : (e.isSelected = !0, o.push(e.value))
                    })), s ? this.hasOptionGroup && this.setGroupsSelectedProp() : o = o[0], this.beforeValueSet(), this.setValue(o, {
                        disableEvent: t
                    }), this.afterValueSet()
                }
            }, {
                ...
                value: function (e) {
                    ...
                    this.disabledOptions.forEach((function (e) {
                        ...
                        if (i && (m.isDisabled = !0 === f[y]), s.isGroupOption && (m.isGroupOption = !0, m.groupIndex = s.groupIndex), l && (m.description = u(p(s[r]))), s.customData && (m.customData = s.customData), t.push(m), d++, g) {
                            var O = m.index;
                            v = !0, b.forEach((function (t) {
                    ...
                    var y = t.length,
                        b = this.$ele;
                    b.options = t, b.length = y, this.options = t, this.visibleOptionsCount = y, this.lastOptionIndex = y - 1, this.newValues = [], this.hasOptionGroup = v, this.setSortedOptions()
                }
            }, {
                ...
                value: function () {
                    ...
                    if (i.length) {
                        ...
                        s = !0, o.forEach((function (e) {
                            ...
                            !1 === n[e.value] && (e.isVisible = !1, o.push(e))
                    ...
                    s ? (this.setVisibleOptionsCount(), this.multiple && this.toggleAllOptionsClass(), this.setValueText()) : this.updatePosition(), l.removeClass(this.$allWrappers, "server-searching")
                }
            }, {
                ...
                value: function () {
                    var e = u(this.sortedOptions),
                        t = 2 * this.optionsCount,
                        i = this.getVisibleStartIndex(),
                        o = this.getNewOption(),
                        s = i + t - 1,
                        n = 0;
                    o && (o.visibleIndex = n, n++), e = e.filter((function (e) {
                        var t = !1;
                        return e.isVisible && !e.isCurrentNew && (t = n >= i && n <= s, e.visibleIndex = n, n++), t
                    })), o && (e = [o].concat(u(e))), this.visibleOptions = e, this.renderOptions()
                }
            }, {
                ...
                value: function () {
                    ...
                    t.forEach((function (t) {
                        ...
                        l.setData(o.querySelector(".vscomp-option-text"), "tooltip", t.label), i && l.setData(o.querySelector(".vscomp-option-description"), "tooltip", t.description)
                    }))
                }
            }, {
                key: "setValue",
                value: function (e) {
                    var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
                        ...
                        r = void 0 !== n && n;
                    e ? Array.isArray(e) ? this.selectedValues = u(e) : this.selectedValues = [e] : this.selectedValues = [];
                    var a = this.getValue();
                ...
                value: function () {
                    var e = [],
                        t = [],
                        i = this.selectedValues.length,
                        o = this.noOfDisplayValues,
                        s = this.showValueAsTags,
                        n = this.$valueText,
                        r = 0,
                        a = this.isAllSelected && !this.hasServerSearch && !this.disableAllOptionsSelectedText && !s;
                    if (a && this.hideValueTooltipOnSelectAll) n.innerHTML = "".concat(this.allOptionsSelectedText, " (").concat(i, ")");
                    else {
                        ...
                        try {
                            for (u.s(); !(p = u.n()).done;) {
                                ...
                                if (!c.isCurrentNew) {
                                    ...
                                    var d = c.label;
                                    if (e.push(d), r++, s) {
                                        var v = '<span class="vscomp-value-tag" data-index="'.concat(c.index, '">\n              <span class="vscomp-value-tag-content">').concat(d, '</span>\n              <span class="vscomp-value-tag-clear-button">\n                <i class="vscomp-clear-icon"></i>\n              </span>\n            </span>');
                                        t.push(v)
                                    } else t.push(d)
                                }
                            }
                        ...
                        var f = i - o;
                        f > 0 && t.push('<span class="vscomp-value-tag more-value-count">+ '.concat(f, " ").concat(this.moreText, "</span>"));
                        var y = e.join(", ");
                        if ("" === y) n.innerHTML = this.placeholder;
                        else if (n.innerHTML = y, this.multiple) {
                            var b = this.maxValues;
                            if (l.hasEllipsis(n) || b || this.alwaysShowSelectedOptionsCount || s) {
                                var g = '<span class="vscomp-selected-value-count">'.concat(i, "</span>");
                                if (b && (g += ' / <span class="vscomp-max-value-count">'.concat(b, "</span>")), a) n.innerHTML = "".concat(this.allOptionsSelectedText, " (").concat(i, ")");
                                else if (s) n.innerHTML = t.join(""), this.$valueTags = n.querySelectorAll(".vscomp-value-tag"), this.setValueTagAttr();
                                else {
                                    var m = 1 === i ? this.optionSelectedText : this.optionsSelectedText;
                                    n.innerHTML = "".concat(g, " ").concat(m)
                                }
                            } else t = []
                        }
                    }
                    var O = "";
                    0 === i ? O = this.placeholder : s || (O = t.join(", ")), l.setData(n, "tooltip", O), this.multiple && l.setData(n, "tooltipEllipsisOnly", 0 === i)
                }
            }, {
                key: "setSearchValue",
                value: function (e) {
                    ...
                    if (e !== this.searchValueOriginal || i) {
                        ...
                        this.searchValue = o, this.searchValueOriginal = e, l.toggleClass(this.$allWrappers, "has-search-value", e), this.afterSetSearchValue()
                    }
                }
            }, {
                ...
                value: function () {
                    var e, t = 0,
                        ...
                        r = this.isOptionVisible.bind(this);
                    this.hasOptionGroup && (e = this.getVisibleOptionGroupsMapping(o)), this.options.forEach((function (a) {
                        var l;
                        a.isCurrentNew || (n && !o ? (a.isVisible = !1, l = {
                            isVisible: !1,
                            hasExactOption: !1
                        }) : l = r({
                            data: a,
                            ...
                            searchGroup: s
                        }), l.isVisible && t++, i || (i = l.hasExactOption))
                    })), this.allowNewOption && (o && !i ? (this.setNewOption(), t++) : this.removeNewOption()), this.visibleOptionsCount = t, this.afterSetVisibleOptionsCount()
                }
            }, {
                key: "setOptionProp",
                value: function (e, t, i) {
                ...
                value: function () {
                    ...
                    e && (this.showAsPopup ? t["max-width"] = e : i.width = e), l.setStyles(this.$dropboxContainer, i), l.setStyles(this.$dropbox, t)
                }
            }, {
                key: "setOptionAttr",
                value: function () {
                    ...
                    if (this.options.forEach((function (e) {
                            if (e.isSelected)
                                if (i) l.push(e);
                                    ...
                                    var t, o = (p(t = {}, n, e.value), p(t, r, e.label), t);
                ...
                key: "openDropbox",
                value: function (e) {
                    this.isSilentOpen = e, e ? l.setStyle(this.$dropboxContainer, "display", "inline-flex") : (l.dispatchEvent(this.$ele, "beforeOpen"), l.setAria(this.$wrapper, "expanded", !0)), this.setDropboxWrapperWidth(), l.removeClass(this.$allWrappers, "closed"), this.dropboxPopover && !e ? this.dropboxPopover.show() : this.afterShowPopper()
                }
            }, {
                key: "afterShowPopper",
                value: function () {
                ...
                key: "closeDropbox",
                value: function (e) {
                    this.isSilentClose = e, this.keepAlwaysOpen ? this.removeOptionFocus() : (e ? l.setStyle(this.$dropboxContainer, "display", "") : (l.dispatchEvent(this.$ele, "beforeClose"), l.setAria(this.$wrapper, "expanded", !1), l.setAria(this.$wrapper, "activedescendant", "")), this.dropboxPopover && !e ? this.dropboxPopover.hide() : this.afterHidePopper())
                }
            }, {
                key: "afterHidePopper",
                value: function () {
                ...
                value: function (e, t) {
                    ...
                    if (t) i = t;
                    else if (o) i = this.getSibling(o, e);
                    else {
                        var s = this.getFirstVisibleOptionIndex();
                        i = this.$dropboxContainer.querySelector('.vscomp-option[data-visible-index="'.concat(s, '"]')), (l.hasClass(i, "disabled") || l.hasClass(i, "group-title")) && (i = this.getSibling(i, "next"))
                    }
                    i && i !== o && (o && this.toggleOptionFocusedState(o, !1), this.toggleOptionFocusedState(i, !0), this.toggleFocusedProp(l.getData(i, "index"), !0), this.moveFocusedOptionToView(i))
                }
            }, {
                key: "moveFocusedOptionToView",
                value: function (e) {
                    if (e || (e = this.$dropboxContainer.querySelector(".vscomp-option.focused")), e) {
                        var t, i = this.$optionsContainer.getBoundingClientRect(),
                        ...
                        s > a ? t = h + c : n < p && (t = h - r + u + c), void 0 !== t && (this.$optionsContainer.scrollTop = t)
                    }
                }
            }, {
                ...
                value: function (e) {
                    ...
                    if (e) {
                        ...
                        var n = this.selectedValues,
                            r = l.getData(e, "value"),
                            a = l.getData(e, "index", "number"),
                            p = !1,
                            u = this.lastSelectedOptionIndex;
                        if (this.lastSelectedOptionIndex = null, this.toggleSelectedProp(a, o), o) {
                            if (this.multiple) n.push(r), this.toggleAllOptionsClass(), this.toggleGroupOptionsParent(e), i && i.shiftKey && (p = !0);
                            else {
                                ...
                                h && this.toggleOptionSelectedState(h, !1), this.closeDropbox()
                            }
                        ...
                        l.hasClass(e, "current-new") && this.beforeSelectNewValue(), this.setValue(n), p && this.selectRangeOptions(u, a)
                    }
                }
            }, {
                ...
                value: function (e, t) {
                    if (this.hasOptionGroup && !this.disableOptionGroupCheckbox && e) {
                        var i = l.getData(e, "groupIndex", "number"),
                    ...
                    if (this.hasOptionGroup && !this.disableOptionGroupCheckbox && e) {
                        ...
                        n.forEach((function (e) {
                            ...
                            if (!e.isDisabled && e.groupIndex === o) {
                                var i = e.value;
                                !t || r && !e.isVisible ? (e.isSelected = !1, a[i] && p(n, i)) : (e.isSelected = !0, a[i] || n.push(i))
                            }
                ...
                value: function () {
                    ...
                    this.options.forEach((function (e) {
                        ...
                        disableValidation: e
                    }), this.afterValueSet(), e && l.removeClass(this.$allWrappers, "has-error"), l.dispatchEvent(this.$ele, "reset")
                }
            }, {
                key: "addOption",
                value: function (e, t) {
                ...
                value: function (e) {
                    var t = e.data,
                        ...
                        l = t.alias,
                        p = -1 !== r.indexOf(i);
                    return t.isGroupTitle && (n && p || (p = s[t.index])), l && !p && (p = -1 !== l.indexOf(i)), a && !p && (p = -1 !== a.toLowerCase().indexOf(i)), t.isVisible = p, o || (o = r === i), {
                        isVisible: p,
                        hasExactOption: o
                    }
                }
                ...
                key: "enable",
                value: function () {
                    this.$ele.disabled = !1, this.$ele.removeAttribute("disabled"), this.$hiddenInput.removeAttribute("disabled"), l.setAria(this.$wrapper, "disabled", !1)
                }
            }, {
                key: "disable",
                value: function () {
                    this.$ele.disabled = !0, this.$ele.setAttribute("disabled", ""), this.$hiddenInput.setAttribute("disabled", ""), l.setAria(this.$wrapper, "disabled", !0)
                }
            }, {
                key: "validate",
                value: function () {
                    ...
                    var e = !1;
                    return this.required && s.isEmpty(this.selectedValues) && (e = !0), l.toggleClass(this.$allWrappers, "has-error", e), !e
                }
            }, {
                key: "destroy",
                value: function () {
                ...
                value: function (e, t) {
                    var i = t;
                    void 0 === i && (i = !l.hasClass(e, "selected")), l.toggleClass(e, "selected", i), l.setAria(e, "selected", i)
                }
            }, {
                key: "toggleOptionFocusedState",
                value: function (e, t) {
                    e && (l.toggleClass(e, "focused", t), t && l.setAria(this.$wrapper, "activedescendant", e.id))
                }
            }]) && d(t.prototype, i), o && d(t, o), Object.defineProperty(t, "prototype", {
                writable: !1
            }), e
        }();
    document.addEventListener("reset", g.onFormReset), document.addEventListener("submit", g.onFormSubmit), window.addEventListener("resize", g.onResizeMethod);
    var m = g.getAttrProps();
    window.VirtualSelect = g, "undefined" != typeof NodeList && NodeList.prototype && !NodeList.prototype.forEach && (NodeList.prototype.forEach = Array.prototype.forEach)
}(),
function () {
    "use strict";
            ...
            return (t = [{
                ...
                value: function () {
                    ...
                    var e, t, n, r = window.innerWidth,
                        ...
                        F = r + M,
                        G = this.offset;
                    G && (P += G, I -= G, M += G, F -= G), "auto" === E && (E = i.getMoreVisibleSides(this.$triggerEle).vertical);
                    var H = {
                            top: {
                                top: C - h - T,
                                left: w + $
                        ...
                        q = H[E];
                    if (C = q.top, w = q.left, A && ("top" === A ? C = x : "bottom" === A ? C = x + b - h : "left" === A ? w = k : "right" === A && (w = k + y - u)), w < M ? "left" === E ? n = "right" : w = M + f > m ? m - f : M : w + u > F && ("right" === E ? n = "left" : w = F + f < S ? S - d : F - u), C < P ? "top" === E ? n = "bottom" : C = P + c > O ? O - c : P : C + h > I && ("bottom" === E ? n = "top" : C = I + c < g ? g - v : I - h), n) {
                        var N = H[n];
                        "top" === (E = n) || "bottom" === E ? C = N.top : "left" !== E && "right" !== E || (w = N.left)
                    }
                    "top" === E ? (e = C + V, t = w) : "right" === E ? (e = C, t = w - V) : "left" === E ? (e = C, t = w + V) : (e = C - V, t = w);
                    var W = "translate3d(".concat(t, "px, ").concat(e, "px, 0)");
                    if (i.setStyle(this.$popperEle, "transform", W), i.setData(this.$popperEle, "fromLeft", t), i.setData(this.$popperEle, "fromTop", e), i.setData(this.$popperEle, "top", C), i.setData(this.$popperEle, "left", w), i.removeClass(this.$popperEle, o.join(" ")), i.addClass(this.$popperEle, "position-".concat(E)), this.hasArrow) {
                        var L = 0,
                            R = 0,
                            j = w + f,
                            B = C + c,
                            ...
                            K = s[E] || "";
                        "top" === E || "bottom" === E ? (L = y / 2 + S - j) < z ? L = z : L > u - z && (L = u - z) : "left" !== E && "right" !== E || ((R = b / 2 + g - B) < z ? R = z : R > h - z && (R = h - z)), i.setStyle(this.$arrowEle, "transform", "translate3d(".concat(L, "px, ").concat(R, "px, 0) ").concat(K))
                    }
            ...
            return i = e, s = [{
                ...
                value: function (t) {
                    ...
                    if (i) {
                        ...
                        var s = [];
                        return i.forEach((function (i) {
                            t.ele = i, e.destory(i), s.push(new e(t))
                        })), o ? s[0] : s
                    }
                }
            }, {
                ...
                value: function (e) {
                    ...
                    s && (r = t.removeArrayEmpty(r.split(" "))).forEach((function (e) {
                        var r = "".concat(a, "-").concat(e),
                            p = i.events[r];
                        p || (p = i[a].bind(i), l && (p = t.throttle(p, l)), i.events[r] = p), "add" === o ? n.addEvent(s, e, p) : n.removeEvent(s, e, p)
                    }))
                }
            }, {
