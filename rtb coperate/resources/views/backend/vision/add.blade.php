                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card col-10 mx-auto">
                                ...
                                <form class="form-horizontal" action="/backoffice/vision/addsub" method="POST" enctype="multipart/form-data">
                                     <div class="card-body">
                                        @csrf
                                        ...
                                        <div class="form-group row">
                                            <label class="col-md-3 col-form-label" for="file-multiple-input">
                                                ...
                                                <div class="col-md-9">
                                                    <textarea name="nameth" id="summernote"></textarea>
                                                </div>
                                            </div>
                                            <script>
                                        ...
                                        <div class="form-group row">
                                            <label class="col-md-3 col-form-label" for="file-multiple-input">
                                                ...
                                                <div class="col-md-9">
                                                    <textarea name="nameen" id="summernote1"></textarea>
                                                </div>
                                            </div>
                                            <script>
                                        ...
                                        <div class="form-group row">
                                            <label class="col-md-3 col-form-label" for="file-multiple-input">
                                                ...
                                                <div class="col-md-9">
                                                    <textarea name="desth" id="summernote3"></textarea>
                                                </div>
                                            </div>
                                            <script>
                                        ...
                                        <div class="form-group row">
                                            <label class="col-md-3 col-form-label" for="file-multiple-input">
                                                ...
                                                <div class="col-md-9">
                                                    <textarea name="desen" id="summernote4"></textarea>
                                                </div>
                                            </div>
                                            <script>
                                            ...
                                            <label class="col-md-3 col-form-label" for="file-multiple-input">
                                                ...
                                                <div class="col-md-9">
                                                    <textarea name="detailth" id="summernote5"></textarea>
                                                </div>
                                            </div>
                                            <script>
                                        ...
                                        <div class="form-group row">
                                            <label class="col-md-3 col-form-label" for="file-multiple-input">
                                                ...
                                                <div class="col-md-9">
                                                    <textarea name="detailen" id="summernote6"></textarea>
                                                </div>
                                            </div>
                                            <script>
                                        ...
                                        <div class="form-group row">
                                            <label class="col-md-3 col-form-label" for="file-multiple-input">
                                                Title 1 TH </label>
                                            <div class="col-md-9">
                                                <input type="text" name="n1th" class="form-control" value="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            Title 1 EN </label>
                                            <div class="col-md-9">
                                                <input type="text" name="n1en" class="form-control" value="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            <label class="col-md-3 col-form-label" for="file-multiple-input">
                                                ...
                                                <div class="col-md-9">
                                                    <textarea name="d1th" id="" style="height:100px"></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <label class="col-md-3 col-form-label" for="file-multiple-input">
                                                Description 1 TH <div style="font-size: 12px;"></div></label>
                                                <div class="col-md-9">
                                                    <textarea name="d1en" id="" style="height:100px"></textarea>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            <label class="col-md-3 col-form-label" for="file-multiple-input">
                                                Title 2 TH </label>
                                            <div class="col-md-9">
                                                <input type="text" name="n2th" class="form-control" value="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            Title 2 EN </label>
                                            <div class="col-md-9">
                                                <input type="text" name="n2en" class="form-control" value="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            <label class="col-md-3 col-form-label" for="file-multiple-input">
                                                ...
                                                <div class="col-md-9">
                                                    <textarea name="d2th" id="" style="height:100px"></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <label class="col-md-3 col-form-label" for="file-multiple-input">
                                                Description 2 TH <div style="font-size: 12px;"></div></label>
                                                <div class="col-md-9">
                                                    <textarea name="d2en" id="" style="height:100px"></textarea>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            <label class="col-md-3 col-form-label" for="file-multiple-input">
                                                Title 3 TH </label>
                                            <div class="col-md-9">
                                                <input type="text" name="n3th" class="form-control" >
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            Title 3 EN </label>
                                            <div class="col-md-9">
                                                <input type="text" name="n3en" class="form-control" >
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            <label class="col-md-3 col-form-label" for="file-multiple-input">
                                                ...
                                                <div class="col-md-9">
                                                    <textarea name="d3th" id="" style="height:100px"></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <label class="col-md-3 col-form-label" for="file-multiple-input">
                                                Description 3 TH <div style="font-size: 12px;"></div></label>
                                                <div class="col-md-9">
                                                    <textarea name="d3en" id="" style="height:100px"></textarea>
                                                </div>
                                            </div>
