                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card col-10 mx-auto">
                                ...
                                <form class="form-horizontal" action="backoffice/cat_news/editsub" method="POST" enctype="multipart/form-data">
                                     <div class="card-body">
                                        @csrf
                                        
                                        <input type="hidden" name="cat_news_id" value="{{ $cat_news->cat_news_id }}">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-md-3 col-form-label" for="file-multiple-input">
                                                Name TH </label>
                                            <div class="col-md-9">
                                                <input type="text" name="nameth" class="form-control" value="{{ $cat_news->nameth }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            <label class="col-md-3 col-form-label" for="file-multiple-input">
                                                Name EN </label>
                                            <div class="col-md-9">
                                                <input type="text" name="nameen" class="form-control" value="{{ $cat_news->nameen}}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="card-footer">
                                            ...
                                            <a href="/backoffice/cat_news" class="btn btn-sm btn-danger">กลับ</a>
