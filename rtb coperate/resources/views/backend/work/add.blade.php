                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card col-10 mx-auto">
                                <div class="card-header"><strong>Work</strong></div>
                                <form class="form-horizontal" action="/backoffice/work/addsub" method="POST" enctype="multipart/form-data">
                                     <div class="card-body">
                                        @csrf
                                        ...
                                        <div class="form-group row">
                                            <label class="col-md-3 col-form-label" for="file-multiple-input">
                                                Job name TH <div style="font-size: 12px;"></div></label>
                                            <div class="col-md-9">
                                                <input type="text" name="job_nameth" class="form-control">
                                            </div>
                                        </div>
                                       
                                        <div class="form-group row">
                                            <label class="col-md-3 col-form-label" for="file-multiple-input">
                                                Job name EN <div style="font-size: 12px;"></div></label>
                                            <div class="col-md-9">
                                                <input type="text" name="job_nameen" class="form-control">
                                            </div>
                                        </div>

                                        <div class="form-group row">
                                            <label class="col-md-3 col-form-label" for="file-multiple-input">
                                                Job description TH <div style="font-size: 12px;"></div></label>
                                                <div class="col-md-9">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-md-3 col-form-label" for="file-multiple-input">
                                                Job description EN <div style="font-size: 12px;"></div></label>
                                                <div class="col-md-9">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-md-3 col-form-label" for="file-multiple-input">
                                                Applicant qualifications TH <div style="font-size: 12px;"></div></label>
                                                <div class="col-md-9">
                                                    <textarea name="applicantth" id="summernote2"></textarea>
                                                </div>
                                            </div>
                                            <script>
                                        ...
                                        <div class="form-group row">
                                            <label class="col-md-3 col-form-label" for="file-multiple-input">
                                                Applicant qualifications EN <div style="font-size: 12px;"></div></label>
                                                <div class="col-md-9">
                                                    <textarea name="applicanten" id="summernote3"></textarea>
                                                </div>
                                            </div>
                                            <script>
