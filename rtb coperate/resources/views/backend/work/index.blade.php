...
<head>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card col-10 mx-auto">
                                <div class="card-header">จัดการ <strong>Work </strong> </div>
                                <div class="card-body">
                                    <div class="text-right">
                                        <a href="/backoffice/work/add" type="button" class="btn btn-dark" > เพิ่ม </a><br><br>
                                    </div>
                                    <table class="table table-responsive-sm text-center">
                                        ...
                                        <tbody>
                                            @foreach ($work as $item)
                                                <tr>
                                                    <td>{{ $item->job_nameth }}</td>
                                                    <td>
                                                        <a href="/backoffice/work/edit/{{ $item->w_id }}" class="btn btn-warning">แก้ไข</a>
                                                        <button type="button" class="btn btn-danger" onclick="batbal('{{$item->w_id}}')">ลบ</button>
    ...
    function batbal(w_id){
        ...
        preConfirm: () => {
            return fetch('/backoffice/work/delete/'+w_id)
