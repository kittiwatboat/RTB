                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card col-10 mx-auto">
                                ...
                                <form class="form-horizontal" action="/backoffice/promotion/addsub" method="POST" enctype="multipart/form-data">
                                     <div class="card-body">
                                        @csrf
                                        ...
                                        <div class="form-group col-md-4">
                                           <label for="aaa">Type</label>
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" name="low_price" class="form-control" value="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            <label class="col-md-3 col-form-label" for="file-multiple-input">
                                                Name TH </label>
                                            <div class="col-md-9">
                                                <input type="text" name="nameth" class="form-control" value="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            <label class="col-md-3 col-form-label" for="file-multiple-input">
                                                Price </label>
                                            <div class="col-md-9">
                                                <input type="text" name="price_minus" class="form-control" value="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            <label class="col-md-3 col-form-label" for="file-multiple-input">
                                                วันเริ่มต้น </label>
                                            <div class="col-md-9">
                                                <input type="datetime-local" name="date_start" class="form-control" value="">
                                            </div>
                                        </div>
                                        ...
                                        <!-- <div class="form-group row">
                                            <label class="col-md-3 col-form-label" for="file-multiple-input">
                                                เวลาเริ่มต้น </label>
                                            <div class="col-md-9">
                                                <input type="time" name="time_start" class="form-control" value="">
                                            </div>
                                        </div> -->
                                        ...
                                        <div class="form-group row">
                                            <label class="col-md-3 col-form-label" for="file-multiple-input">
                                                วันสิ้นสุด </label>
                                            <div class="col-md-9">
                                                <input type="datetime-local" name="date_end" class="form-control" value="">
                                            </div>
                                        </div>
                                        ...
                                        <!-- <div class="form-group row">
                                            <label class="col-md-3 col-form-label" for="file-multiple-input">
                                                เวลาสิ้นสุด </label>
                                            <div class="col-md-9">
                                                <input type="time" name="time_end" class="form-control" value="">
                                            </div>
                                        </div> -->
