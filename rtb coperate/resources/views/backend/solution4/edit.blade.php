                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card col-10 mx-auto">
                                ...
                                <form class="form-horizontal" action="backoffice/solution4/editsub" method="POST" enctype="multipart/form-data">
                                     <div class="card-body">
                                        @csrf
                                        
                                        <input type="hidden" name="solution4_id" value="{{ $solution4->solution4_id }}">



                                        <?php  $for=DB::table('solution3')->get();  ?>
                                         <div class="form-group col-md-4">
                                           <label for="aaa">Type</label>
                                            <select name="solution3_id" id="aaa" class="form-control">
                                            @foreach($for as $fors)
                                            <option <?php if(isset($solution4)){ if($solution4->solution3_id == $fors->solution3_id){echo 'selected';} } ?>
                                        ...
                                        <div class="form-group row">
                                            <label class="col-md-3 col-form-label" for="file-multiple-input">
                                                Name TH </label>
                                            <div class="col-md-9">
                                                <input type="text" name="nameth" class="form-control" value="{{ $solution4->nameth }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            <label class="col-md-3 col-form-label" for="file-multiple-input">
                                                Name EN </label>
                                            <div class="col-md-9">
                                                <input type="text" name="nameen" class="form-control" value="{{ $solution4->nameen}}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            <label class="col-md-3 col-form-label" for="file-multiple-input">
                                                ...
                                                <div class="col-md-9">
                                                    <textarea name="detailth" id="summernote">{!! $solution4->detailth !!}</textarea>
                                                </div>
                                            </div>
                                            <script>
                                        ...
                                        <div class="form-group row">
                                            <label class="col-md-3 col-form-label" for="file-multiple-input">
                                                ...
                                                <div class="col-md-9">
                                                    <textarea name="detailen" id="summernote1">{!! $solution4->detailen !!}</textarea>
                                                </div>
                                            </div>
                                            <script>
                                         ...
                                         <!-- <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <img src="{{ $solution4->solution4_img }}" width='50%' alt=""><br>
                                        ...
                                        <div class="card-footer">
                                            ...
                                            <a href="/backoffice/solution4" class="btn btn-sm btn-danger">กลับ</a>
