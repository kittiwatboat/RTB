                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card col-10 mx-auto">
                                ...
                                <form class="form-horizontal" action="backoffice/solution3/editsub" method="POST" enctype="multipart/form-data">
                                     <div class="card-body">
                                        @csrf
                                        
                                        <input type="hidden" name="solution3_id" value="{{ $solution3->solution3_id }}">



                                        <?php  $for=DB::table('solution2')->get();  ?>
                                         <div class="form-group col-md-4">
                                           <label for="aaa">Type</label>
                                            <select name="solution2_id" id="aaa" class="form-control">
                                            @foreach($for as $fors)
                                            <option <?php if(isset($solution3)){ if($solution3->solution2_id == $fors->solution2_id){echo 'selected';} } ?>
                                        ...
                                        <div class="form-group row">
                                            <label class="col-md-3 col-form-label" for="file-multiple-input">
                                                Name TH </label>
                                            <div class="col-md-9">
                                                <input type="text" name="nameth" class="form-control" value="{{ $solution3->nameth }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            <label class="col-md-3 col-form-label" for="file-multiple-input">
                                                Name EN </label>
                                            <div class="col-md-9">
                                                <input type="text" name="nameen" class="form-control" value="{{ $solution3->nameen}}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            <label class="col-md-3 col-form-label" for="file-multiple-input">
                                                ...
                                                <div class="col-md-9">
                                                    <textarea name="desth" id="" style="height:100px">{{ $solution3->desth }}</textarea>
                                                </div>
                                            </div>
                                            ...
                                            Description EN <div style="font-size: 12px;"></div></label>
                                                <div class="col-md-9">
                                                    <textarea name="desen" id="" style="height:100px">{{ $solution3->desen }}</textarea>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            <label class="col-md-3 col-form-label" for="file-multiple-input">
                                                ...
                                                <div class="col-md-9">
                                                    <textarea name="detailth" id="summernote">{!! $solution3->detailth !!}</textarea>
                                                </div>
                                            </div>
                                            <script>
                                        ...
                                        <div class="form-group row">
                                            <label class="col-md-3 col-form-label" for="file-multiple-input">
                                                ...
                                                <div class="col-md-9">
                                                    <textarea name="detailen" id="summernote1">{!! $solution3->detailen !!}</textarea>
                                                </div>
                                            </div>
                                            <script>
                                         ...
                                         <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <img src="{{ $solution3->solution3_img }}" width='50%' alt=""><br>
                                                <input id="file-multiple-input" type="file" name="solution3_img"
                                                    multiple="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="card-footer">
                                            ...
                                            <a href="/backoffice/solution3" class="btn btn-sm btn-danger">กลับ</a>
