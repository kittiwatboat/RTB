                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card col-10 mx-auto">
                                ...
                                <form class="form-horizontal" action="backoffice/news/editsub" method="POST" enctype="multipart/form-data">
                                     <div class="card-body">
                                        @csrf
                                        ...
                                        <div class="form-group row">
                                            <label class="col-md-3 col-form-label" for="file-multiple-input">
                                                Name TH </label>
                                            <div class="col-md-9">
                                                <input type="text" name="nameth" class="form-control" value="{{ $news->nameth }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            <label class="col-md-3 col-form-label" for="file-multiple-input">
                                                Name EN </label>
                                            <div class="col-md-9">
                                                <input type="text" name="nameen" class="form-control" value="{{ $news->nameen}}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            <label class="col-md-3 col-form-label" for="file-multiple-input">
                                                ...
                                                <div class="col-md-9">
                                                    <textarea name="detailth" id="summernote">{!! $news->detailth !!}</textarea>
                                                </div>
                                            </div>
                                            <script>
                                        ...
                                        <div class="form-group row">
                                            <label class="col-md-3 col-form-label" for="file-multiple-input">
                                                ...
                                                <div class="col-md-9">
                                                    <textarea name="detailen" id="summernote1">{!! $news->detailen !!}</textarea>
                                                </div>
                                            </div>
                                            <script>
                                         ...
                                         <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <img src="{{ $news->news_img }}" width='50%' alt=""><br>
                                                <input id="file-multiple-input" type="file" name="news_img"
                                                    multiple="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="card-footer">
                                            ...
                                            <a href="/backoffice/news" class="btn btn-sm btn-danger">กลับ</a>
