...
<head>
                            ...
                            <div class="card col-10 mx-auto">
                                ...
                                <div class="card-body">
                                    <div class="text-right">
                                        <a href="/backoffice/news/add" type="button" class="btn btn-dark" > เพิ่ม </a><br><br>
                                    </div>
                                    <table class="table table-responsive-sm text-center">
                                        ...
                                        <tbody>
                                            @foreach ($news as $item)
                                                <tr>
                                                    <td>{{ $item->nameth }}</td>
                                                    <td><img src="{{ $item->news_img }}" width="20%" alt=""></td>
                                                    <td>
                                                        <a href="/backoffice/news/edit/{{ $item->news_id }}" class="btn btn-warning">แก้ไข</a>
                                                        <button type="button" class="btn btn-danger" onclick="batbal('{{$item->news_id}}')">ลบ</button>
    ...
    function batbal(news_id){
        ...
        preConfirm: () => {
            return fetch('/backoffice/news/delete/'+news_id)
