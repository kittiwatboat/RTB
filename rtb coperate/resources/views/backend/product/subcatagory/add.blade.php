                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card col-10 mx-auto">
                                ...
                                <form class="form-horizontal" action="/backoffice/subcatagory/addsub" method="POST" enctype="multipart/form-data">
                                     <div class="card-body">
                                        @csrf
                                        
                                        <div class="form-group row">
                                            <label class="col-md-3 col-form-label" for="file-multiple-input">
                                                Category <div style="font-size: 12px;"></div></label>
                                            <div class="col-md-3">
                                                <select name="cat_id" class="form-control">
                                                    @foreach ($cat as $item)
                                                    <option value="{{ $item->cat_id }}">{{ $item->nameth }}</option> 
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" name="subnameth" class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" name="subnameen" class="form-control">
                                            </div>
                                        </div>
