...
<head>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card col-10 mx-auto">
                                <div class="card-header">จัดการ <strong>Subcatagory </strong> </div>
                                <div class="card-body">
                                    <div class="text-right">
                                        <a href="/backoffice/subcatagory/add" type="button" class="btn btn-dark" > เพิ่ม </a><br><br>
                                    </div>
    ...
    function batbal(scat_id){
        ...
        preConfirm: () => {
            return fetch('/backoffice/subcatagory/delete/'+scat_id)
