                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card col-10 mx-auto">
                                ...
                                <form class="form-horizontal" action="/backoffice/product type/typeeditsub" method="POST" enctype="multipart/form-data">
                                     <div class="card-body">
                                        @csrf
                                        <input type="hidden" name="pt_id" value="{{ $protype->pt_id }}">
                                        <div class="form-group row">
                                            <label class="col-md-3 col-form-label" for="file-multiple-input">
                                                Subcatagory <div style="font-size: 12px;"></div></label>
                                            <div class="col-md-3">
                                                <select name="scat_id" class="form-control">
                                                    @foreach ($cat as $ca)
                                                        <optgroup label="{{ $ca->nameth }}">
                                                                @foreach ($scat as $item)
                                                                    @if ($item->scat_id == $protype->scat_id)
                                                                        @if ($ca->cat_id == $item->cat_id)
                                                                            <option value="{{ $item->scat_id }}" selected>{{ $item->subnameth }}</option> 
                                                                        @endif    
                                                                    @else
                                                                        @if ($ca->cat_id == $item->cat_id)
                                                                            <option value="{{ $item->scat_id }}">{{ $item->subnameth }}</option> 
                                                                        @endif
                                                                    @endif
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" name="typenameth" value="{{ $protype->typenameth }}" class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" name="typenameen" value="{{ $protype->typenameen }}" class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <img src="{{ $protype->type_img }}" width="20%" alt="">
                                                <input id="file-multiple-input" type="file" name="type_img"
                                                    multiple="">
                                            </div>
                                        </div>
                                    </div>
                                        <div class="card-footer">
                                            ...
                                            <a href="/backoffice/product type" class="btn btn-sm btn-danger">กลับ</a>
