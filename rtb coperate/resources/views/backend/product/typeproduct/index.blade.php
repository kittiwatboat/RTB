...
<head>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card col-10 mx-auto">
                                <div class="card-header">จัดการ <strong>Product Type </strong> </div>
                                <div class="card-body">
                                    <div class="text-right">
                                        <a href="/backoffice/product type/add" type="button" class="btn btn-dark" > เพิ่ม </a><br><br>
                                    </div>
                                        ...
                                        <tbody>
                                            @foreach ($protype as $item)
                                                <tr>
                                                    ...
                                                    <td><img src="{{ $item->type_img }}" width="20%" alt=""></td>
                                                    <td>
                                                        <a href="/backoffice/product type/typeedit/{{ $item->pt_id }}" class="btn btn-warning">แก้ไข</a>
                                                        <button type="button" class="btn btn-danger" onclick="batbal('{{$item->pt_id}}')">ลบ</button>
    ...
    function batbal(pt_id){
        ...
        preConfirm: () => {
            return fetch('/backoffice/product type/delete/'+pt_id)
