                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card col-10 mx-auto">
                                ...
                                <form class="form-horizontal" action="/backoffice/catagory/catagoryeditsub" method="POST" enctype="multipart/form-data">
                                     <div class="card-body">
                                        @csrf
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" name="nameth" class="form-control" value="{{ $cat->nameth }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" name="nameen" class="form-control" value="{{ $cat->nameen }}">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-md-3 col-form-label" for="file-multiple-input">
                                                ...
                                                <div class="col-md-9">
                                                    <textarea name="detailth" id="summernote">{!! $cat->detailth !!}</textarea>
                                                </div>
                                            </div>
                                            <script>
                                        ...
                                        <div class="form-group row">
                                            <label class="col-md-3 col-form-label" for="file-multiple-input">
                                                ...
                                                <div class="col-md-9">
                                                    <textarea name="detailen" id="summernote1">{!! $cat->detailen !!}</textarea>
                                                </div>
                                            </div>
                                            <script>
                                        ...
                                        <div class="card-footer">
                                            ...
                                            <a href="/backoffice/catagory" class="btn btn-sm btn-danger">กลับ</a>
