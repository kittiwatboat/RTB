...
<head>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card col-10 mx-auto">
                                <div class="card-header">จัดการ <strong>Catagory </strong> </div>
                                <div class="card-body">
                                    <div class="text-right">
                                        <a href="/backoffice/catagory/add" type="button" class="btn btn-dark" > เพิ่ม </a><br><br>
                                    </div>
                                        ...
                                        <tbody>
                                            @foreach ($cat as $item)
                                                <tr>
                                                    <th>{{ $item->nameth }}</th>
                                                    <th>
                                                        <a href="/backoffice/catagory/catagoryedit/{{ $item->cat_id }}" class="btn btn-warning">แก้ไข</a>
                                                        <button type="button" class="btn btn-danger" onclick="batbal('{{$item->cat_id}}')">ลบ</button>
    ...
    function batbal(cat_id){
        ...
        preConfirm: () => {
            return fetch('/backoffice/catagory/delete/'+cat_id)
