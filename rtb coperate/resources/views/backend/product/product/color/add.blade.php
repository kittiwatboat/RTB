                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card col-10 mx-auto">
                                <div class="card-header"><strong>feature</strong></div>
                                <form class="form-horizontal" action="/backoffice/product/color/addsub" method="POST" enctype="multipart/form-data">
                                     <div class="card-body">
                                        @csrf
                                       ...
                                       <input type="hidden" name="pro_id" value="{{ $pro->pro_id }}">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    <input  type="file" id="imgInp" name="proimg"
                                                        multiple=""><br>
